...
Tile("water_sand_t.png", speed=0.6, tags=["water"])
Tile("water_sand_r.png", speed=0.6, tags=["water"])
Tile("water_sand_b.png", speed=0.6, tags=["water"])
Tile("water_sand_l.png", speed=0.6, tags=["water"])
Tile("water_sand_tl.png", speed=0.6, tags=["water"])
Tile("water_sand_tr.png", speed=0.6, tags=["water"])
Tile("water_sand_bl.png", speed=0.6, tags=["water"])
Tile("water_sand_br.png", speed=0.6, tags=["water"])
Tile("water_sand_tbl.png", speed=0.6, tags=["water"])
Tile("water_sand_tbr.png", speed=0.6, tags=["water"])
Tile("water_sand_tlr.png", speed=0.6, tags=["water"])
Tile("water_sand_blr.png", speed=0.6, tags=["water"])
...
Tile("water_sand_tl_tl.png", speed=0.6, tags=["water"])
