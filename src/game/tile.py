...
Tile("water_deep.png", solid=True, tags=["water-deep"])
...
Tile("water_deep_sand_t.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_r.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_b.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_l.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tl.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tr.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_bl.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_br.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tbl.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tbr.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tlr.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_blr.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tl2.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tr2.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_bl2.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_br2.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tl_bl.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tl_tr.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_tr_br.png", solid=True, tags=["water-deep"])
Tile("water_deep_sand_bl_br.png", solid=True, tags=["water-deep"])
